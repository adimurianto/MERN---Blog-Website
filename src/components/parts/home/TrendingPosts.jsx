					...
					<div className="row">
						<div className="col-lg-6 col-md-12">
							<div className="news-post image-post">
								<img src="upload/blog/home5/a1.jpg" allt=""/>
						...
						<div className="col-lg-6 col-md-12">
							<div className="row">
								<div className="col-md-6">
									<div className="news-post standard-post left-align">
										<div className="image-holder">
											<a href="single-post.html"><img src="upload/blog/home2/m2.jpg" allt=""/></a>
										</div>
								...
								<div className="col-md-6">
									<div className="news-post standard-post left-align">
										<div className="image-holder">
											<a href="single-post.html"><img src="upload/blog/home2/m3.jpg" allt=""/></a>
										</div>
										<a className="text-link" href="#">Travel</a>
							...
							<div className="row">
								<div className="col-md-6">
									<div className="news-post standard-post left-align">
										<div className="image-holder">
											<a href="single-post.html"><img src="upload/blog/home2/m6.jpg" allt=""/></a>
										</div>
								...
								<div className="col-md-6">
									<div className="news-post standard-post left-align">
										<div className="image-holder">
											<a href="single-post.html"><img src="upload/blog/home2/m7.jpg" allt=""/></a>
										</div>
